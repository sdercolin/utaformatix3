...
enum class Strings(val en: String, val ja: String, val zhCN: String) {
    ...
    ImportFileSubDescription(
        en = "Supported file types: VSQX, VPR, VSQ, MID(VOCALOID), USTs, USTX, CCS, MUSICXML, XML, SVP, S5P, DV, PPSF(NT)",
        ja = "サポートされているファイル形式：VSQX、VPR、VSQ、MID（VOCALOID）、UST（複数可）、USTX、CCS、MUSICXML、XML、SVP、S5P、DV、PPSF（NT）",
        zhCN = "支持的文件类型：VSQX、VPR、VSQ、MID（VOCALOID）、UST（允许复数个）、USTX、CCS、MUSICXML、XML、SVP、S5P、DV、PPSF（NT）"
    ),
