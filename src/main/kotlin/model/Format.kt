...
enum class Format(
    ...
    companion object {
        val importable get() = listOf(Vsqx, Vpr, Vsq, VocaloidMid, Ust, Ustx, Ccs, Csst, Tssln, MusicXml, Svp, S5p, Dv, Ppsf)
        val exportable get() = listOf(Vsqx, Vpr, Vsq, VocaloidMid, Ust, Ustx, Ccs, Csst, Tssln, MusicXml, Svp, S5p, Dv)
    }
}
